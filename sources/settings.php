	...
	if(isset($user['username'])) {
		...
		if(isset($_GET['b']) && $_GET['b'] == 'security') {
			...
			if($userSettings['gender'] == '0') {
				...
				$TMPL['bgender'] = 'selected="selected"';
			} else {
				$TMPL['sgender'] = 'selected="selected"';
			}
			...
			} elseif($userSettings['interests'] == '2') {
				$TMPL['winterests'] = 'selected="selected"';
			} elseif($userSettings['interests'] == '3') {
				$TMPL['mwinterests'] = 'selected="selected"';                
			} else {
				$TMPL['cinterests'] = 'selected="selected"';
			}
		}
		$page .= $skin->make();
